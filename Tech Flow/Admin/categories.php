<?php
    ...
    if(isset($_GET['type']) && $_GET['type']!=''){
      ...
      if($type=='status')
      {
        ...
        $update_sts = "update catagories set status='$status' where id='$id' ";
        mysqli_query($con,$update_sts);
      }
      if($type=='delete')
      {
        $id=get_safe_val($con,$_GET['id']);
        $delete_sts = "delete from catagories  where id='$id' ";
        mysqli_query($con,$delete_sts);
      }
    }
    $sql = "SELECT * FROM catagories order by catagories asc";
                  ...
                  <div class="col-xl-12">
                     <div class="card">
                        <div class="card-body">
                           ...
                           <h5 class="box-title"><a href="add_catagories.php">Add Catagories</a></h5>
                        </div>
                        <div class="card-body--">
                                 ...
                                 <tbody>
                                    ...
                                    while($row=mysqli_fetch_assoc($res)) { ?>
                                      <tr>
                                       ...
                                       echo "<span class='badge badge-edit'><a href='add_catagories.php?id=".$row['id']."'>Edit</a></span>&nbsp";
