<?php
    ...
    if(isset($_GET['type']) && $_GET['type']!=''){
      ...
      if($type=='status')
      {
        ...
        $update_sts = "update carousel set status='$status' where id='$id' ";
        mysqli_query($con,$update_sts);
      }
      if($type=='delete')
      {
        $id=get_safe_val($con,$_GET['id']);
        $delete_sts = "delete from carousel  where id='$id' ";
                  ...
                  <div class="col-xl-12">
                     <div class="card">
                        <div class="card-body">
                           ...
                           <h5 class="box-title"><a href="add_news_carousel.php">Add Carousel</a></h5>
                        </div>
                        <div class="card-body--"> 
                                 ...
                                 <tbody>
                                    ...
                                    while($row=mysqli_fetch_assoc($res)) { ?>
                                      <tr>
                                       ...
                                       echo "<span class='badge badge-edit'><a href='add_news_carousel.php?id=".$row['id']."'>Edit</a></span>&nbsp";
